...
const sessionStatusViews: Record<SessionStatus, SessionStatusView> = {
	...
	no_signal: { status: "no_signal", label: "No signal", className: "text-passive" },
	...
	review_pending: { status: "review_pending", label: "Review pending", className: "text-muted-foreground" },
	draft: { status: "draft", label: "Draft PR", className: "text-muted-foreground" },
	pr_open: { status: "pr_open", label: "PR open", className: "text-muted-foreground" },
